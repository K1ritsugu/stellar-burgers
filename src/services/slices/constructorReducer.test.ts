...
describe('constructor actions', () => {
  ...
  describe('reorder ingredient', () => {
    test('move up', () => {
      const idx = 1;
      const endState: constructorState = JSON.parse(JSON.stringify(startState));
      [
        endState.constructorItems.ingredients[idx],
        endState.constructorItems.ingredients[idx - 1]
      ] = [
        endState.constructorItems.ingredients[idx - 1],
        endState.constructorItems.ingredients[idx]
      ];

      const newState = constructorReducer(startState, moveIngredientUp(idx));
    ...
    test('move down', () => {
      ...
      const newState = constructorReducer(startState, moveIngredientDown(idx));
